...
bootnet <- function(
  ...
  default = c("none", "EBICglasso", "pcor","IsingFit","IsingSampler", "huge","adalasso","mgm","relimp","cor","TMFG"), # Default method to use. EBICglasso, IsingFit, concentration, some more....

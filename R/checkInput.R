...
checkInput <- function(
  default = c("none", "EBICglasso","EBICglasso2", "pcor","IsingFit","IsingSampler", "huge","adalasso","mgm","relimp", "cor","TMFG"),
 ...
 if (missing(fun)){
  ...
  if (construct == "function"){
    ...
    } else if (default == "EBICglasso2"){
      Function <- bootnet_EBICglasso2
